...
### 1) Basit kullanım
`uretim-takip/index.html` dosyasını tarayıcıda direkt açabilirsiniz (çift tıklama). Bu sürüm modül-CORS sorunu yaşamaması için tek runtime script ile çalışır.
